...
Die Datenvisualisierung ist einer der wichtigsten Schritte im Prozess der Datenanalyse. Sie ist nicht nur Teil der Datenanalyse, sondern kann auch als Kunst betrachtet werden. Die Programmiersprache R stellt uns ein leistungsstarkes Visualisierungspaket zur Verfügung, `ggplot2`.
...
Die ggplot2 impliziert die "Grammatik der Grafik", die auf dem Prinzip beruht, dass ein Plot in die folgenden grundlegenden Teile aufgeteilt werden kann -
